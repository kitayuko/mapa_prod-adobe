...
map.getView().fit([-12142160.786738, 2944543.637898, -11500056.897501, 3735054.231005], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Producción de adobe en Chihuahua 2010-25</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (145 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ubicación de los establecimientos que fabrican adobes en el estado de Chihuahua, activos entre 2010 y 2025, registrados en el DENUE por el INEGI.';
            }
